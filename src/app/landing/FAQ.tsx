...
const FAQ = () => {
  ...
  const Ans1 = (<>Certainly, we welcome and value your feedback. For any inquiries, concerns, or constructive feedback, please feel free to{" "}<a href="mailto:Nephara@outlook.com">Email us</a>.{" "}Your input is instrumental in maintaining and enhancing our commitment to excellence.</>);
  ...
  const Ans5 = (<>In the event that you are unable to attend your scheduled appointment, we appreciate advance notice. Kindly{" "} <a href="mailto:nephara@outlok.com">email us</a>{" "}at your earliest convenience, and our dedicated team will assist you in rescheduling or exploring refund options with the utmost professionalism.</>);

  const Q6 = "What if the Doctor does not show up at the scheduled time?";
  const Ans6 = (<> While our practitioners are committed to punctuality, unforeseen circumstances may arise. If your assigned doctor is delayed, we kindly request your understanding for a brief waiting period of up to 5 minutes. In the rare event of a prolonged delay, promptly{" "}       <a href="mailto:nephara@outlok.com">email us</a>
