    ...
    return (
        <div className='w-full h-16 sm:min-h-20 lg:mt-4 xl:mt-0 2xl:min-h-24 flex items-center justify-between'>
            <div className='lg:ml-16 xl:ml-0'>
                <p className='text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-semibold'>Profile dashboard</p>
            ...
            <div className="items-center hidden sm:flex justify-center ml-[10%] relative cursor-pointer" onClick={handleDropdownToggle} >
                <Image src={userInfo[0]?.photo ? userInfo[0].photo : ''} alt='Profile' width={100} height={100} className='w-14 h-14 border rounded-full object-cover' placeholder="blur" blurDataURL={img64} />
