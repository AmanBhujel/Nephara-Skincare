    ...
    return (
        windowWidth > 1024 ? (
            ...
            <div className='absolute bottom-2 w-[95%] shadow-lg h-20 bg-white border rounded-xl flex item-center justify-center'>
                <div className=' w-[33%] h-full flex flex-col items-center justify-center hover:text-[#ba58ff] cursor-pointer'>
                ...
                <div className=' w-[33%] h-full flex flex-col items-center justify-center hover:text-[#a322ff] cursor-pointer'>
