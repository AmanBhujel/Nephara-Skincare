...
const Page = () => {
    ...
    return (
        <main className='w-full h-screen flex justify-center items-center bg-[#f6f8fc]'>
            {/* Sidebar */}
            <div className='h-full w-72 md:w-80 fixed top-0 left-0 z-50 bg-white border-r-2'>
                ...
                <div className='relative flex w-full justify-center items-center flex-col mt-6'>
                    ...
                    <div className='bg-[#f4f0fd] w-[75%] h-60 mt-[-18px] z-10 rounded-[8px] flex flex-col items-center justify-center'>
                ...
                <div className='bottom-0 absolute flex items-center justify-center w-full '>
                    <p
                        className={`w-[90%] cursor-pointer text-xl font-semibold py-4 px-2 flex items-center mb-2 rounded-[10px] 
                         text-gray-600 hover:bg-[#7650e0] hover:text-white`}
                    >
