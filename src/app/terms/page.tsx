...
const TermsAndConditions = () => {
    return (
        <div className='bg-white '>
            ...
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Nephara if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>Updates to Terms and Conditions</p>
            ...
            <p>No Liability for Physical Harm:</p>
            ...
            <p>For any inquiries or assistance regarding refunds, rescheduling, or appointment-related matters, please reach out to us at nephara@outlook.com. Our team is here to assist you and ensure your satisfaction with our services.</p>
        </div>
    );
};
