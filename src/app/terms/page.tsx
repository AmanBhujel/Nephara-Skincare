...
const TermsAndConditions = () => {
    ...
    <div className='w-[50%] px-4 sm:px-0 mb-8'>
    <div className='mt-8'><h1 className='text-3xl font-bold text-center'>Terms and Conditions</h1>
    </div>
        <p className='text-2xl font-bold mt-3 mb-1'>Welcome to Nephara!</p>
            ...
            <h2><strong>Data Collection and Use</strong></h2>
            ...
            <h2><strong>Updates to Terms and Conditions</strong></h2>
            ...
            <h2><strong>Rescheduling Policy:</strong></h2>
            ...
            <h2><strong>Professional Guidance:</strong></h2>
            ...
            <h2><strong>No Medical Diagnosis:</strong></h2>
            ...
            <h2><strong>Personal Responsibility:</strong></h2>
            ...
            <h2><strong>Consultation Results:</strong></h2>
            ...
            <h2><strong>No Liability for Physical Harm:</strong></h2>
            ...
            <h2><strong>Seeking Medical Attention:</strong></h2>
            ...
            <h2><strong>Continued Care:</strong></h2>
            ...
            <h2><strong>Consultation Agreement:</strong></h2>
            ...
            <h2><strong>Refund Eligibility:</strong></h2>
            ...
            <h2><strong>Rescheduling Option:</strong></h2>
